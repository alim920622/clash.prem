...
.method public final calculateValueOfAnimationAtEndOfExpansion(Lcom/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec;Lcom/google/android/material/animation/MotionTiming;F)F
    ...
    .line 7
    sget-object p2, Lcom/google/android/material/animation/AnimationUtils;->LINEAR_INTERPOLATOR:Landroid/view/animation/LinearInterpolator;

    const/4 p2, 0x0

    invoke-static {p2, p3, p1, p3}, Landroidx/constraintlayout/solver/widgets/analyzer/DependencyGraph$$ExternalSyntheticOutline0;->m(FFFF)F
...
.method public final onCreateExpandedStateChangeAnimation(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 80
    iget-object v14, v4, Lcom/google/android/material/transformation/FabTransformationBehavior$FabTransformationSpec;->positioning:Lcom/google/android/material/animation/Positioning;
    ...
    .line 85
    invoke-virtual {v0, v1, v2, v14}, Lcom/google/android/material/transformation/FabTransformationBehavior;->calculateTranslationY(Landroid/view/View;Landroid/view/View;Lcom/google/android/material/animation/Positioning;)F
    ...
    invoke-virtual {v9, v14}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;->getContentRect(Landroid/graphics/Rect;)Z
    ...
    .line 93
    invoke-static {v13, v10, v15, v15}, Landroidx/core/util/DebugUtils;->dist(FFFF)F

    move-result v18

    .line 94
    invoke-static {v13, v10, v6, v15}, Landroidx/core/util/DebugUtils;->dist(FFFF)F

    move-result v19

    .line 95
    invoke-static {v13, v10, v6, v7}, Landroidx/core/util/DebugUtils;->dist(FFFF)F

    move-result v6

    .line 96
    invoke-static {v13, v10, v15, v7}, Landroidx/core/util/DebugUtils;->dist(FFFF)F
    ...
    .line 157
    invoke-static {v0, v1}, Lkotlin/jvm/internal/ArrayIteratorKt;->playTogether(Landroid/animation/AnimatorSet;Ljava/util/List;)V
