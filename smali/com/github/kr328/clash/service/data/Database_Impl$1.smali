.class public final Lcom/github/kr328/clash/service/data/Database_Impl$1;
...
# instance fields
.field public final synthetic this$0:Lcom/github/kr328/clash/service/data/Database_Impl;


# direct methods
.method public constructor <init>(Lcom/github/kr328/clash/service/data/Database_Impl;)V
    .locals 0
...
.method public final createAllTables(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `imported` (`uuid` TEXT NOT NULL, `name` TEXT NOT NULL, `type` TEXT NOT NULL, `source` TEXT NOT NULL, `interval` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`uuid`))"

    invoke-virtual {p1, v0}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v0, "CREATE TABLE IF NOT EXISTS `pending` (`uuid` TEXT NOT NULL, `name` TEXT NOT NULL, `type` TEXT NOT NULL, `source` TEXT NOT NULL, `interval` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL, PRIMARY KEY(`uuid`))"
...
.method public final onValidateSchema(Landroidx/sqlite/db/SupportSQLiteDatabase;)Landroidx/room/RoomOpenHelper$ValidationResult;
    ...
    const-string v3, "imported(com.github.kr328.clash.service.data.Imported).\n Expected:\n"
    ...
    const-string v3, "pending(com.github.kr328.clash.service.data.Pending).\n Expected:\n"
    ...
    const-string v3, "selections(com.github.kr328.clash.service.data.Selection).\n Expected:\n"
